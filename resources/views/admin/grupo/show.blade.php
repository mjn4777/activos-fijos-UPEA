            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/admin/grupo/' . $grupo->id . '/edit') }}" title="Edit Grupo"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Descripción </th><td> {{ $grupo->descrip }} </td></tr><tr><th> Vida útil </th><td> {{ $grupo->vidautil }} </td></tr>
                                </tbody>
                            </table>
                        </div>
